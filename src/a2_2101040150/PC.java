...
public class PC {
     ...
     * </pre>
     */
    public PC(@AttrRef("manufacturer") String manufacturer, @AttrRef("year") int year, @AttrRef("model") String model, @AttrRef("comps") Set<String> comps) throws NotPossibleException {
